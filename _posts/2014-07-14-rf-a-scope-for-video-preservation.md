...
![]({{ site.url }}/assets/img/rf_signalexplained.jpg){:width="500px"}
...
![]({{ site.url }}/assets/img/normalrf1.jpg){:width="500px"}
...
![]({{ site.url }}/assets/img/rf_partialheadclog1.jpg){:width="500px"}
...
![]({{ site.url }}/assets/img/rf_fullheadclog1.jpg){:width="500px"}
